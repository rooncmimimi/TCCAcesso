...
const navigationMock = { navigate: mockNavigate } as unknown as NativeStackScreenProps<ProfileStackParamList, "Activities">["navigation"] &
...
async function renderTela() {
  const utils = await render(
    <AccessibilityProvider>
      <ThemeProvider>
        <ActivitiesScreen navigation={navigationMock} route={{ key: "Activities", name: "Activities" }} />
      </ThemeProvider>
    </AccessibilityProvider>,
  );
  ...
  it("toque numa publicação curtida navega para PostagemDetail com o postagemId certo", async () => {
    mockMinha.mockResolvedValue({
      ...
      interacoesFeed: {
        curtidas: {
          total: 1,
          itens: [{ id: "cur1", postagem: { id: "post1", conteudo: "Minha primeira publicação", usuarioId: "x", created_at: "2026-01-05T10:00:00.000Z" } }],
        },
        comentarios: { itens: [], total: 0 },
        compartilhamentos: { itens: [], total: 0 },
      },
