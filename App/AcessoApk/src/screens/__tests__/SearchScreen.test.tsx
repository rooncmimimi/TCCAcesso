...
const navigationMock = { navigate: mockNavigate } as unknown as NativeStackScreenProps<ProfileStackParamList, "Search">["navigation"] &
...
async function renderTela() {
  const utils = await render(
    <AccessibilityProvider>
      <ThemeProvider>
        <SearchScreen navigation={navigationMock} route={{ key: "Search", name: "Search" }} />
      </ThemeProvider>
    </AccessibilityProvider>,
  );
