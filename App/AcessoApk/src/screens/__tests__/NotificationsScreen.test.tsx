...
const navigationMock = {
  ...
  NativeStackScreenProps<AppTabParamList, "Notifications">["navigation"];
  ...
  const utils = await render(
    <AccessibilityProvider>
      <ThemeProvider>
        ...
        <NotificationsScreen navigation={navigationMock} route={{ key: "Notifications", name: "Notifications" }} />
      </ThemeProvider>
    </AccessibilityProvider>,
  );
