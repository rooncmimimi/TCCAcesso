...
describe("BuscaService", () => {
  ...
  describe("buscarResumo", () => {
    it("chama GET /busca com tipo=tudo e devolve o envelope intacto", async () => {
      ...
      expect(apiClient.get).toHaveBeenCalledWith("/busca", { params: { q: "dev", tipo: "tudo" } });
  ...
  describe("buscarUsuarios", () => {
    it("chama GET /busca com tipo=usuarios e os parâmetros de página", async () => {
      ...
      expect(apiClient.get).toHaveBeenCalledWith("/busca", { params: { q: "ana", tipo: "usuarios", page: 2, limit: 10 } });
    ...
    it("sem parâmetros de página, manda só q e tipo", async () => {
      ...
      expect(apiClient.get).toHaveBeenCalledWith("/busca", { params: { q: "ana", tipo: "usuarios" } });
    });
  });
  ...
  describe("buscarEmpresas", () => {
    it("chama GET /busca com tipo=empresas", async () => {
      ...
      expect(apiClient.get).toHaveBeenCalledWith("/busca", { params: { q: "acme", tipo: "empresas", page: 1, limit: 10 } });
    });
  });
  ...
  describe("buscarVagas", () => {
    it("chama GET /busca com tipo=vagas", async () => {
      ...
      expect(apiClient.get).toHaveBeenCalledWith("/busca", { params: { q: "dev", tipo: "vagas" } });
    });
  });
  ...
  describe("buscarPostagens", () => {
    it("chama GET /busca com tipo=postagens", async () => {
      ...
      expect(apiClient.get).toHaveBeenCalledWith("/busca", { params: { q: "oi", tipo: "postagens" } });
    });
