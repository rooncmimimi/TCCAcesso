...
const navigationMock = {
  ...
  NativeStackScreenProps<AbasParamList, "Messages">["navigation"];
  ...
  const utils = await render(
    <AcessibilidadeProvider>
      <TemaProvider>
        ...
        <MensagensScreen navigation={navigationMock} route={{ key: "Messages", name: "Messages" }} />
      </TemaProvider>
    </AcessibilidadeProvider>,
  );
