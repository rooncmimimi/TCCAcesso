...
// Cast proposital: a tela recebe `navigation` por prop (`CompositeScreenProps`) e só usa
// `navigate`, então o teste simula só isso.
const navigationMock = {
  navigate: mockNavigate,
} as unknown as NativeStackScreenProps<AppStackParamList, "Tabs">["navigation"] &
  NativeStackScreenProps<AbasParamList, "Jobs">["navigation"];
  ...
  const utils = await render(
    <AcessibilidadeProvider>
      <TemaProvider>
        ...
        <VagasScreen navigation={navigationMock} route={{ key: "Jobs", name: "Jobs" }} />
      </TemaProvider>
    </AcessibilidadeProvider>,
  );
...
describe("VagasScreen", () => {
  ...
  // O título vem com a contagem como subtítulo, então o teste também cobre o singular.
