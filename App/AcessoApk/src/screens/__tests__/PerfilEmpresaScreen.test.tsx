...
// Os atalhos "Minhas vagas" e "Atividades" usam `useNavigation()`: o restante do módulo continua
// real e só `useNavigation` vira um mock controlável, com o `NavigationContainer` real envolvendo a
// tela no `renderTela`.
