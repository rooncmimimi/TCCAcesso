  ...
  const utils = await render(
    <AcessibilidadeProvider>
      <TemaProvider>
        ...
        <SecaoCurriculo candidato={candidato} onAtualizado={onAtualizado} />
      </TemaProvider>
    </AcessibilidadeProvider>,
  );
...
describe("SecaoCurriculo", () => {
  ...
  it("não existe nenhum botão de excluir currículo (sem rota no backend)", async () => {
