...
import { CandidaturasVagaScreen } from "../CandidaturasVagaScreen";
...
describe("CandidaturasVagaScreen", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  ...
  describe("status da candidatura", () => {
    it("alterar o status chama atualizarStatusCandidatura e atualiza o selo", async () => {
      ...
      // `ControleSegmentado`; as duas confirmam que a lista foi atualizada
