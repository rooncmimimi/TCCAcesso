...
jest.mock("../../../autenticacao", () => ({
  useAutenticacao: () => ({
    cadastrarCandidato: mockRegisterCandidato,
    cadastrarEmpresa: mockRegisterEmpresa,
  }),
  AutenticacaoService: {
...
async function renderTela(onVoltarParaLogin = jest.fn()) {
  const utils = await render(
    <AcessibilidadeProvider>
      <TemaProvider>
        <CadastroScreen onVoltarParaLogin={onVoltarParaLogin} />
      </TemaProvider>
    </AcessibilidadeProvider>,
  );
...
describe("CadastroScreen", () => {
  ...
  it("candidato: cadastro válido chama cadastrarCandidato com o payload certo (sem senha de confirmação)", async () => {
  ...
  it("empresa: cadastro válido chama cadastrarEmpresa com o payload certo", async () => {
