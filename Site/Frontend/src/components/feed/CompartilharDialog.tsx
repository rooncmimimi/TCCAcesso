...
function urlDaPostagem(postagemId: string): string {
...
export function CompartilharDialog({ postagemId, trigger }: { postagemId: string; trigger: React.ReactNode }) {
...
export default CompartilharDialog;
