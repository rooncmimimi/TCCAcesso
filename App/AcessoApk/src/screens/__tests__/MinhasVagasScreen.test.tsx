...
import { MinhasVagasScreen } from "../MinhasVagasScreen";
...
const navigationMock = { navigate: mockNavigate } as unknown as NativeStackScreenProps<PerfilStackParamList, "MyJobs">["navigation"];

async function renderTela() {
  const utils = await render(
    <AcessibilidadeProvider>
      <TemaProvider>
        <MinhasVagasScreen navigation={navigationMock} route={{ key: "MyJobs", name: "MyJobs" }} />
      </TemaProvider>
    </AcessibilidadeProvider>,
  );
